    ...
    while(True):
        ...
        if(my_cascade.face_type > 0):
            ...
            if(my_cascade.face_type > 0):
                ...
                cv2.putText(frame, "YAW: {:.2f}".format(yaw), (300, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                cv2.putText(frame, "Pitch: {:.2f}".format(pitch), (300, 50), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
